...
public class Housing extends Zone {
    public Housing(int line, int column){
        super(line, column , CellType.Housing);
    }
    ...
    public int calculateOutput(){
        ...
        if(level==0){
            ...
            throw new IllegalArgumentException("Error: Housing level must be 0-3. Given: " + level);
        }
    }
    ...
    public void updateLevel(){
        try {
            ...
            if (receivedElectricity < 0 || receivedWater < 0 || receivedInternet < 0 || receivedLifestyle < 0) {
            ...
            int targetLevel = 0;
            boolean hasLevel1Req = (receivedElectricity > 0 && receivedWater > 0 && receivedInternet > 0);
            boolean hasLevel2Req = (hasLevel1Req && hasSecurity && hasHealth && hasEducation);
            boolean hasLevel3Req = (hasLevel2Req && (receivedLifestyle> 0));
            ...
            System.out.println("Error: Updating housing level. " + e.getMessage());
            this.level=0;
        }
    }
}